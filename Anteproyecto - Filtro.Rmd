...
dsuaz_n <- as.data.frame(sapply(dsuaz[,c(1,2,4,5,8,14,15,16,17,19,23)], minmax))
```
...
```{r}
dsuaz_train <- dsuaz_n[1:113,]
dsuaz_testing <- dsuaz_n[114:141,]
dim(dsuaz_testing_labels)
dim(dsuaz_train)
dsuaz_train_labels <- dsuaz[1:113,21]
dsuaz_testing_labels <- dsuaz[114:141,21]
